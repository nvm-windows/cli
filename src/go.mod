...
replace common/urlguard v1.0.0 => ../../common/urlguard
...
replace common/verify v1.0.0 => ../../common/verify

replace common/verifycache v1.0.0 => ../../common/verifycache

replace common/mirrorauth v1.0.0 => ../../common/mirrorauth
